...
function () {
  ...
  _createClass(Configuration, [{
    ...
    value: function openURL(url, data, timeout) {
      ...
      var mockUrlData = this.main.components.fileSystem.readFile("?mock_urls.blockpy");
      mockUrlData = JSON.parse(mockUrlData);
          ...
          if (mockUrlData.hasOwnProperty(filename)) {
            for (var i = 0; i < mockUrlData[filename].length; i += 1) {
              if (mockUrlData[filename][i] === url) {
                var fileData = _this2.main.components.fileSystem.readFile(filename);
