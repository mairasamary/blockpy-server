...
class UserCounts(Base):
    ...
    last_logged_in: Mapped[Optional[datetime]] = mapped_column(UtcDateTime, default=None)
    last_edited: Mapped[Optional[datetime]] = mapped_column(UtcDateTime, default=None)